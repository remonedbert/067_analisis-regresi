...
data <- read_excel("C:\\Users\\bagan\\Downloads\\NSC-2025.xlsx", sheet="Sheet2")
...
Koef_det
```
keragamannya dri si Y 48% dari si X( hanya bole pake buat yg sederhana kalo ganda pake yang bawah)
...
Didapatkan nilai $\hat\beta_0 = 84.2552$ artinya nilai dugaan indeks pembangunan manusia ketika persentase penduduk miskin bernilai 0 persen adalah 84.2552%, akan tetapi nilai 0 persen tidak terdapat dalam selang pengamatan persentase penduduk miskin sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut. Nilai $\hat\beta_1 = -0.9377205$ artinya nilai dugaan indeks pembangunan manusia jika persentase penduduk miskin meningkat sebesar satu persen adalah sebesar 0.9377 poin persentase dengan arah penurunan. Koefisien determinasi yang dihasilkan adalah 0.48314 atau 48.314% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase penduduk miskin adalah sebesar 48.314%, sisanya yaitu 51.686% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
